...
public class Mercenary extends Character implements WithoutForce {
	private static Mercenary instance = new Mercenary();
	...
	protected static Mercenary getInstance() throws IOException {
